          ...
          <div className="col-span-4 space-y-4">
            ...
            {!isRunning ? (
              <button onClick={handleStart} disabled={strategies.length === 0}
                className="w-full py-3 rounded-lg font-semibold text-sm bg-brand hover:bg-brand-dark text-black transition-all disabled:opacity-40 disabled:cursor-not-allowed">
                Start Paper Trading
              </button>
            ) : (
              <button onClick={stop}
